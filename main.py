...
and delivers them via Telegram at 08:00 CST (UTC+8).

Usage:
    python main.py              # Start scheduler (runs daily at 08:00 CST)
...
def main():
    ...
    if args.run_now:
        ...
        logger.info("Scheduler started — next report at 08:00 CST daily")
